...
},{"./modules/LastfmApi":2}],2:[function(require,module,exports){
'use strict';
...
var LastfmApi = (function () {
    ...
    _createClass(LastfmApi, [{
        key: 'construct',
        value: function construct(apiKey) {
            this.apiKey = apiKey;
        }
    }, {
...
},{"core-js/shim":72,"regenerator-babel/runtime":73}],4:[function(require,module,exports){
'use strict';
// false -> Array#indexOf
// true  -> Array#includes
var $ = require('./$');
...
},{"./$":17,"./$.array-includes":4,"./$.array-methods":5,"./$.assert":6,"./$.cof":8,"./$.def":13,"./$.invoke":15,"./$.replacer":21,"./$.uid":26}],30:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":17,"./$.def":13,"./$.unscope":27}],31:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":17,"./$.def":13,"./$.unscope":27}],32:[function(require,module,exports){
var $def = require('./$.def');
$def($def.P, 'Array', {
...
},{"./$.array-methods":5,"./$.def":13,"./$.unscope":27}],33:[function(require,module,exports){
var $def = require('./$.def');
$def($def.P, 'Array', {
...
},{"./$.array-methods":5,"./$.def":13,"./$.unscope":27}],34:[function(require,module,exports){
var $     = require('./$')
  , ctx   = require('./$.ctx')
  , $def  = require('./$.def')
  , $iter = require('./$.iter')
...
},{"./$":17,"./$.ctx":12,"./$.def":13,"./$.iter":16}],35:[function(require,module,exports){
var $          = require('./$')
...
},{"./$.def":13}],37:[function(require,module,exports){
...
},{"./$.collection":11,"./$.collection-strong":9}],40:[function(require,module,exports){
var Infinity = 1 / 0
  , $def  = require('./$.def')
  , E     = Math.E
  , pow   = Math.pow
...
},{"./$.def":13}],41:[function(require,module,exports){
'use strict';
var $          = require('./$')
  , isObject   = $.isObject
  , isFunction = $.isFunction
...
},{"./$":17,"./$.def":13}],43:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":7,"./$.def":13}],44:[function(require,module,exports){
...
},{"./$.def":13}],45:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $def = require('./$.def');
$def($def.S, 'Object', {setPrototypeOf: require('./$.set-proto')});
},{"./$.def":13,"./$.set-proto":22}],46:[function(require,module,exports){
var $        = require('./$')
  , $def     = require('./$.def')
  , isObject = $.isObject
  , toObject = $.toObject;
...
},{"./$":17,"./$.def":13}],47:[function(require,module,exports){
'use strict';
...
},{"./$":17,"./$.cof":8,"./$.wks":28}],48:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , ctx     = require('./$.ctx')
  , cof     = require('./$.cof')
...
},{"./$":17,"./$.assert":6,"./$.cof":8,"./$.ctx":12,"./$.def":13,"./$.iter":16,"./$.species":23,"./$.task":25,"./$.uid":26,"./$.wks":28}],49:[function(require,module,exports){
var $         = require('./$')
  , $def      = require('./$.def')
...
},{"./$":17,"./$.assert":6,"./$.ctx":12,"./$.def":13,"./$.iter":16,"./$.own-keys":19,"./$.set-proto":22,"./$.uid":26}],50:[function(require,module,exports){
var $      = require('./$')
  , cof    = require('./$.cof')
  , RegExp = $.g.RegExp
  , Base   = RegExp
...
},{"./$":17,"./$.cof":8,"./$.replacer":21,"./$.species":23}],51:[function(require,module,exports){
'use strict';
var strong = require('./$.collection-strong');
...
},{"./$.collection":11,"./$.collection-strong":9}],52:[function(require,module,exports){
var $def = require('./$.def');
$def($def.P, 'String', {
  // 21.1.3.3 String.prototype.codePointAt(pos)
  codePointAt: require('./$.string-at')(false)
});
},{"./$.def":13,"./$.string-at":24}],53:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def')
...
},{"./$":17,"./$.cof":8,"./$.def":13}],54:[function(require,module,exports){
var $def    = require('./$.def')
...
},{"./$":17,"./$.def":13}],55:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":17,"./$.cof":8,"./$.def":13}],56:[function(require,module,exports){
var set   = require('./$').set
...
},{"./$":17,"./$.def":13}],58:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":17,"./$.def":13}],59:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":17,"./$.cof":8,"./$.def":13}],60:[function(require,module,exports){
'use strict';
...
},{"./$":17,"./$.cof":8,"./$.def":13,"./$.keyof":18,"./$.uid":26,"./$.wks":28}],61:[function(require,module,exports){
'use strict';
var $         = require('./$')
...
},{"./$":17,"./$.collection":11,"./$.collection-weak":10}],62:[function(require,module,exports){
'use strict';
...
},{"./$.collection":11,"./$.collection-weak":10}],63:[function(require,module,exports){
...
},{"./$.array-includes":4,"./$.def":13,"./$.unscope":27}],64:[function(require,module,exports){
...
},{"./$":17,"./$.def":13,"./$.own-keys":19}],65:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":17,"./$.def":13}],66:[function(require,module,exports){
// https://gist.github.com/kangax/9698100
var $def = require('./$.def');
$def($def.S, 'RegExp', {
  escape: require('./$.replacer')(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
});
},{"./$.def":13,"./$.replacer":21}],67:[function(require,module,exports){
// https://github.com/mathiasbynens/String.prototype.at
var $def = require('./$.def');
$def($def.P, 'String', {
  at: require('./$.string-at')(true)
});
},{"./$.def":13,"./$.string-at":24}],68:[function(require,module,exports){
...
},{"./$":17,"./$.ctx":12,"./$.def":13}],69:[function(require,module,exports){
...
},{"./$":17,"./$.iter":16,"./$.wks":28,"./es6.array.iterator":35}],70:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":13,"./$.task":25}],71:[function(require,module,exports){
...
},{"./$":17,"./$.def":13,"./$.invoke":15,"./$.partial":20}],72:[function(require,module,exports){
require('./modules/es5');
...
},{"./lib/babel/polyfill":3}],75:[function(require,module,exports){
"use strict";

module.exports = require("babel-core/polyfill");

},{"babel-core/polyfill":74}]},{},[1,75])
